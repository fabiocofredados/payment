...
public class RsaService {
    ...
    public static String encryptCardNumber(String cardNumber, String base64PublicKey) throws Exception{
        RSAPublicKey rsaPublicKey = RsaService.base64StringToPublicKey(base64PublicKey);
        String encrypted = RsaService.encryptDataRsa(cardNumber, rsaPublicKey);
        return encrypted;
    }

    public static String decryptCardNumber(String cardNumber, String base64PrivateKey) throws Exception{
        RSAPrivateKey rsaPrivateKey = RsaService.base64StringToPrivateKey(base64PrivateKey);
        String decrypted = RsaService.decryptDataRsa(cardNumber, rsaPrivateKey);
        return decrypted;
    }
